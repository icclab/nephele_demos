...
possibleLaunchfiles_tb2_init = ['startmapping_tb2', 'bringup_tb2', 'savemap_tb2']
...
async def triggerBringup_tb2_handler(params):
    ...
    resources = await exposed_thing.read_property('allAvailableResources_tb2')
