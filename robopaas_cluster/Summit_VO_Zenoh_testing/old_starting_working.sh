...
screen -S summit -p zenoh -X exec docker exec -it ros2 bash -c "export ROS_DISTRO=humble; export RMW_IMPLEMENTATION=rmw_cyclonedds_cpp; export CYCLONEDDS_URI=file:////home/summit/cyclonedds-zenoh.xml; source /home/ros/colcon_ws/install/setup.bash; zenoh-bridge-ros2dds -c /home/summit/zenoh-bridge-conf.json5"
