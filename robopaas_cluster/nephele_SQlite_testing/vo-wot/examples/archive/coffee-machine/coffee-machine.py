...
async def main():
    ...
    await exposed_thing.properties['schedules'].write([])
    ...
    async def served_counter_write_handler(value):
    ...
    await exposed_thing.properties['servedCounter'].write(read_from_sensor('servedCounter'))
