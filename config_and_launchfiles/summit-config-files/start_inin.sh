...
screen -S summit -p ros2 -X exec docker run --rm -it --privileged --network=host --ipc=host --pid=host --name ros2 --env UID=$(id -u) --env GID=$(id -g)  -v /dev/:/dev/ -v /home/summit:/home/summit -v /dev/lidar_front:/dev/lidar_front -v /dev/lidar_rear:/dev/lidar_rear -v /dev/astra_s:/dev/astra_s -v /dev/ttyUSB_gripper:/dev/ttyUSB_gripper robopaas/rosdocked-humble-nephele-summit:robopaas bash -c "export ROS_DISTRO=humble; export RMW_IMPLEMENTATION=rmw_cyclonedds_cpp; export CYCLONEDDS_URI=file:////home/summit/nephele-demo/cyclonedds-bridge.xml; source /home/ros/colcon_ws/install/setup.bash; zenoh-bridge-ros2dds -c /home/summit/nephele-demo/zenoh-bridge-conf-filtered_inin.json5"
# wait for container to start
sleep 5s

#In another window we have the ros2 container that will start the robot base
screen -S summit -X screen -t ros2_rsp
screen -S summit -p ros2 -X exec docker exec -it ros2 bash -c "export ROS_DISTRO=humble; export RMW_IMPLEMENTATION=rmw_cyclonedds_cpp; export CYCLONEDDS_URI=file:////home/summit/nephele-demo/cyclonedds-bridge.xml; source /home/ros/colcon_ws/install/setup.bash; ros2 launch icclab_summit_xl summit_xl_real.launch.py"
# wait for container to start
sleep 1s
...
screen -S summit -p front_camera -X exec docker exec -it ros2 bash -c "export ROS_DISTRO=humble; export RMW_IMPLEMENTATION=rmw_cyclonedds_cpp; export CYCLONEDDS_URI=file:////home/summit/nephele-demo/cyclonedds-bridge.xml; source /home/ros/colcon_ws/install/setup.bash; ros2 launch icclab_summit_xl astra_mini.launch.py"
sleep 1s

#In the same container we will also start the vo-wot environment
screen -S summit -X screen -t vo-wot
screen -S summit -p vo-wot -X exec docker exec -it ros2 bash -c "export ROS_DISTRO=humble; export RMW_IMPLEMENTATION=rmw_cyclonedds_cpp; export CYCLONEDDS_URI=file:////home/summit/nephele-demo/cyclonedds-bridge.xml; source /home/ros/colcon_ws/install/setup.bash; vo-wot -t summit-td.json -f summit.yaml summit.py"
...
screen -S summit -p moveit -X exec docker exec -it ros2 bash -c "export ROS_DISTRO=humble; export RMW_IMPLEMENTATION=rmw_cyclonedds_cpp; export CYCLONEDDS_URI=file:////home/summit/nephele-demo/cyclonedds-bridge.xml; source /home/ros/colcon_ws/install/setup.bash; sudo Xvfb :99 -screen 0 1024x768x16"
sleep 5s
...
screen -S summit -p gps -X exec docker exec -it ros2 bash -c "export ROS_DISTRO=humble; export RMW_IMPLEMENTATION=rmw_cyclonedds_cpp; export CYCLONEDDS_URI=file:////home/summit/nephele-demo/cyclonedds-bridge.xml; source /home/ros/colcon_ws/install/setup.bash; ros2 launch icclab_summit_xl ublox_gps_node_zedf9p-launch.py"
sleep 1s

#In the same container we will also start rtabmap
screen -S summit -X screen -t rtabmap
screen -S summit -p rtabmap -X exec docker exec -it ros2 bash -c "export ROS_DISTRO=humble; export RMW_IMPLEMENTATION=rmw_cyclonedds_cpp; export CYCLONEDDS_URI=file:////home/summit/nephele-demo/cyclonedds-bridge.xml; source /home/ros/colcon_ws/install/setup.bash; ros2 launch icclab_summit_xl rtabmap.launch.py use_sim_time:=False"
sleep 1s
